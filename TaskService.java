...
//method to update existing task
 ...
 public void updateTaskNameById(String taskID, String taskName) {
	 for (Task idNums : taskList){
	 		if ( taskID == idNums.getId()) {
	 			idNums.setName(taskName);
	 		}
	 		else {
	 			throw new IllegalArgumentException("No Task with that ID");
	 		}
 ...
 public void updateTaskDescriptionById(String taskID, String taskDescription) {
	 for (Task idNums : taskList){
	 		if ( taskID == idNums.getId()) {
	 			idNums.setDescription(taskDescription);
	 		}
	 		else {
	 			throw new IllegalArgumentException("No Task with that ID");
	 		}
